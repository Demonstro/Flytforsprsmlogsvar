import svgPaths from "./svg-2eey3bky2c";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[351px]" data-name="Content">
      ...
      <div className="content-stretch flex flex-col items-start pt-[24px] relative shrink-0 w-full" data-name="Heading">
        <p className="font-['Borna:SemiBold',sans-serif] leading-[36px] not-italic relative shrink-0 text-[#0f0f0f] text-[30px] tracking-[-0.12px] w-full">Sjekk svaret ditt</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-start pb-[8px] relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#0f0f0f] text-[16px] tracking-[-0.064px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">Din personlige kode</p>
      </div>
    </div>
  );
}
...
function PlaceholderText() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start justify-between min-h-px min-w-px relative" data-name="Placeholder text">
      <div className="flex flex-col font-['Open_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#676767] text-[16px] text-justify tracking-[-0.064px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">{`tre-norske-ord `}</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Icons/Navigation/Cross">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
          <g id="x 1">
            <path d={svgPaths.p2f9c6900} fill="var(--fill-0, #676767)" id="Union" />
          </g>
        </svg>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#2b5944] content-stretch flex gap-[8px] items-center min-h-[44px] px-[20px] py-[10px] relative rounded-[9999px] shrink-0" data-name="Button base">
      <div className="flex flex-col font-['Open_Sans:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[16px] text-white tracking-[-0.064px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[24px]">Sjekk svar</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[24px] items-start pb-[24px] px-[12px] relative w-full">
        ...
        <div className="content-stretch flex flex-col items-start pb-[12px] relative shrink-0 w-[343px]" data-name="Search input">
...
export default function AskQuestionCheck() {
  return (
    <div className="bg-[#f5f3f0] content-stretch flex flex-col items-center relative size-full" data-name="Ask question - Check">
